...
This is a sample wrapped prompt generated by the framework after evaluating and selecting the Terminal Biome Generator idea. The evaluation classified it as BUILD NOW. The user selected it, and the framework produced the following guided build prompt.

Paste a prompt like this as a **user message** in a new chat session to begin the guided build loop.
